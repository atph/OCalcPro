...
namespace PPL_Model_Wrapper
{
   ...
   public class LoadCase : ElementBase
   {
      ...
      public override bool IsLegalChild(ElementBase pChildCandidate)
      {
        ...
        //   Include When Substituting:   Yes
        //   Enum Values:
        //        1 Iteration P-Δ  (Static Single iteration P-Delta)
        //        2nd Order P-Δ  (Static Fully Converged P-Delta)
        public enum Deflection_val
        {
           [Description("Linear")]
           Linear,    //Static No P-Delta iterations performed
           [Description("1 Iteration P-Δ")]
           Deflection_1_Iteration_P_Delta,    //Static Single iteration P-Delta
        ...
        public Deflection_val String_to_Deflection_val(string pKey)
        {
           switch (pKey)
           {
                ...
                case "1 Iteration P-Δ":
                   return Deflection_val.Deflection_1_Iteration_P_Delta;    //Static Single iteration P-Delta
                case "2nd Order P-Δ":
                   return Deflection_val.Deflection_2nd_Order_P_Delta;    //Static Fully Converged P-Delta
                default:
                   break;
           }
           throw new Exception("string does not match enum value");
        ...
        public string Deflection_val_to_String(Deflection_val pKey)
        {
           switch (pKey)
           {
                ...
                case Deflection_val.Deflection_1_Iteration_P_Delta:
                   return "1 Iteration P-Δ";    //Static Single iteration P-Delta
                case Deflection_val.Deflection_2nd_Order_P_Delta:
                   return "2nd Order P-Δ";    //Static Fully Converged P-Delta
                default:
                   break;
           }
           throw new Exception("enum value unexpected");
   ...
   public class PoleSegment : ElementBase
   {
      ...
      public override bool IsLegalChild(ElementBase pChildCandidate)
      {
        ...
        public Function_val String_to_Function_val(string pKey)
        {
           switch (pKey)
           {
                case "Linear":
                   return Function_val.Linear;    //Linear
                case "Logarithmic":
                   return Function_val.Logarithmic;    //Logarithmic
                case "Squared":
                   return Function_val.Squared;    //Squared
                case "Cubed":
                   return Function_val.Cubed;    //Cubed
                case "Fourth Power":
                   return Function_val.Fourth_Power;    //Fourth Power
                default:
                   break;
           }
           throw new Exception("string does not match enum value");
        ...
        public string Function_val_to_String(Function_val pKey)
        {
           switch (pKey)
           {
                case Function_val.Linear:
                   return "Linear";    //Linear
                case Function_val.Logarithmic:
                   return "Logarithmic";    //Logarithmic
                case Function_val.Squared:
                   return "Squared";    //Squared
                case Function_val.Cubed:
                   return "Cubed";    //Cubed
                case Function_val.Fourth_Power:
                   return "Fourth Power";    //Fourth Power
                default:
                   break;
           }
           throw new Exception("enum value unexpected");
   ...
   public class SteelPole : ElementBase
   {
      ...
      public override bool IsLegalChild(ElementBase pChildCandidate)
      {
        ...
        //   Description:   The pedastal moment capacity
        //   Displayed Units:   store as FTLBS display as FTLBS or NEWTONMETERS
        //   User Level Required:   All user levels may access this attribute
        //   Attribute Type:   FLOAT
        //   Default Value:   90000
        ...
        //   Description:   The pedastal buckling capacity
   ...
   public class SpanBundle : ElementBase
   {
      ...
      public override bool IsLegalChild(ElementBase pChildCandidate)
      {
        ...
        public Type_val String_to_Type_val(string pKey)
        {
           ...
           {
                case "Overlashed":
                   return Type_val.Overlashed;    //Overlashed
                case "Spacers":
                   return Type_val.Spacers;    //Spacers
                case "Bonded":
                   return Type_val.Bonded;    //Bonded
                case "Twist/Braid":
                   return Type_val.Twist_Braid;    //Twist/Braid
                default:
                   break;
           }
           throw new Exception("string does not match enum value");
        ...
        public string Type_val_to_String(Type_val pKey)
        {
           switch (pKey)
           {
                case Type_val.Overlashed:
                   return "Overlashed";    //Overlashed
                case Type_val.Spacers:
                   return "Spacers";    //Spacers
                case Type_val.Bonded:
                   return "Bonded";    //Bonded
                case Type_val.Twist_Braid:
   ...
   public class Clearance : ElementBase
   {
      ...
      public override bool IsLegalChild(ElementBase pChildCandidate)
      {
        ...
        public Group_val String_to_Group_val(string pKey)
        {
           ...
           {
                case "Primary Span":
                   return Group_val.Primary_Span;    //Primary Span
                case "Secondary":
                   return Group_val.Secondary;    //Secondary
                case "Telco":
                   return Group_val.Telco;    //Telco
                default:
                   break;
           }
           throw new Exception("string does not match enum value");
        ...
        public string Group_val_to_String(Group_val pKey)
        {
           switch (pKey)
           {
                case Group_val.Primary_Span:
                   return "Primary Span";    //Primary Span
                case Group_val.Secondary:
                   return "Secondary";    //Secondary
                case Group_val.Telco:
                   return "Telco";    //Telco
                default:
                   break;
           }
